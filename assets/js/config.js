...
(function () {
  ...
  var SOURCES = [
    { id: 'live', name: 'انتشار زنده', scope: 'تازه‌ترین انتشار سرور (هر ساعت، دو دور ۳۰ دقیقه‌ای)', phase: 'fast' },
    ...
    { id: 'btrader', name: 'بورس‌تریدر', scope: 'شاخص هم‌وزن و فرابورس، جریانِ پولِ خرد، تحرکاتِ صندوق‌ها — از انتشارِ سرور (هر ساعت)', phase: 'fast' },
    // مکملِ بورس دوم: صفحه‌ی عمومیِ tablokhani.com (بدون کلید، نسل ۹) — روندِ پول
    { id: 'tbl', name: 'تابلوخوانی', scope: 'ارزشِ کلِ معاملات، صف‌ها، پهنا و جریانِ حقیقی/حقوقی — از انتشارِ سرور (هر ساعت)', phase: 'fast' },
